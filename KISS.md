...
* Finally, we should remember that we are all as one in our effort toward a higher goal (LISA science!), and that we should honor the selfless commitment of so many talented individuals by fostering diversity through inclusion, and by striving to realize an **empowering, embracing, and egalitarian environment**.
